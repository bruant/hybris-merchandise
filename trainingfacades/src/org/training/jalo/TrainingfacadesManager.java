...
/**
 * This is the extension manager of the Trainingfacades extension.
 */
public class TrainingfacadesManager extends GeneratedTrainingfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TrainingfacadesManager.class.getName());
	 ...
	 */
	public static TrainingfacadesManager getInstance()
	{
		return (TrainingfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TrainingfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TrainingfacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TrainingfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TrainingfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TrainingfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
